...
### 설치 / 재설치 / 업데이트 (macOS · Linux)

```bash
bash <(curl -fsSL https://raw.githubusercontent.com/glukupikr0n/OCR-your-Greek-Latin/main/setup.sh)
```
...
> 처음이면 클론, 이미 있으면 pull 후 설치·빌드합니다. 완료 후 `.app`이 `/Applications`에 자동 설치됩니다.
